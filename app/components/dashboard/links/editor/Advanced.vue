...
<template>
  <TabsContent value="settings" class="space-y-4 pt-4 outline-none">
    <FieldGroup>
  ...
  <TabsContent value="social" class="space-y-4 pt-4 outline-none">
    <FieldGroup>
  ...
  <TabsContent value="routing" class="space-y-6 pt-4 outline-none">
    <div class="space-y-4">
      <div>
